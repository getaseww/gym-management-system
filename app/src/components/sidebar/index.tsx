...
import { defaultNavItems, NavItem } from "./components/NavItems";
import {
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            className="grid place-content-center text-black hover:bg-indigo-800 w-10 h-10 rounded-full opacity-0 md:opacity-100"
